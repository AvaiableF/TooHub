...
function gerarFrase() {
  ...
  do {
      var randomIndex = Math.floor(Math.random() * elogios_pt.length);
      frase = elogios_pt[randomIndex];
...
function atualizarContador() {
  var contador = elogios_pt.length - frasesSorteadas.length;
